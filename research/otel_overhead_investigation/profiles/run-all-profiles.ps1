...
$variantSpec = @{
  'k-perf' = @{
    Display = 'k-perf'
    Jar     = 'kmp-examples\fibonacci\fibonacci-k-perf\build\lib\fibonacci-k-perf-jvm-0.1.0-flushEarly-false.jar'
    Js      = 'kmp-examples\fibonacci\fibonacci-k-perf\build\js\packages\fibonacci-k-perf-flushEarly-false\kotlin\fibonacci-k-perf-flushEarly-false.js'
    Exe     = 'kmp-examples\fibonacci\fibonacci-k-perf\build\bin\mingwX64\releaseExecutable\fibonacci-k-perf-flushEarly-false.exe'
    JsDir   = 'js-kperf'                                                      # legacy dir name (no hyphen)
    NeedsCollector = $false
  }
  'otel' = @{
    Display = 'otel (JSON/HTTP)'
    Jar     = 'kmp-examples\fibonacci\fibonacci-otel\build\lib\fibonacci-otel-jvm-1.0.0.jar'
    Js      = 'kmp-examples\fibonacci\fibonacci-otel\build\js\packages\fibonacci-otel\kotlin\fibonacci-otel.js'
    Exe     = 'kmp-examples\fibonacci\fibonacci-otel\build\bin\mingwX64\releaseExecutable\main.exe'
    JsDir   = 'js-otel'
    NeedsCollector = $true
  }
  'otel-proto' = @{
    Display = 'otel-proto (Protobuf/gRPC)'
    Jar     = 'kmp-examples\fibonacci\fibonacci-otel-proto\build\lib\fibonacci-otel-proto-jvm-1.0.0.jar'
    Js      = 'kmp-examples\fibonacci\fibonacci-otel-proto\build\js\packages\fibonacci-otel-proto\kotlin\fibonacci-otel-proto.js'
    Exe     = 'kmp-examples\fibonacci\fibonacci-otel-proto\build\bin\mingwX64\releaseExecutable\main.exe'
    JsDir   = 'js-otel-proto'
    NeedsCollector = $true
  }
  'otel-proto-sampler' = @{
    Display = 'otel-proto-sampler (Protobuf/gRPC + alwaysOn sampler)'
    Jar     = 'kmp-examples\fibonacci\fibonacci-otel-proto-sampler\build\lib\fibonacci-otel-proto-sampler-jvm-1.0.0.jar'
    Js      = 'kmp-examples\fibonacci\fibonacci-otel-proto-sampler\build\js\packages\fibonacci-otel-proto-sampler\kotlin\fibonacci-otel-proto-sampler.js'
    Exe     = 'kmp-examples\fibonacci\fibonacci-otel-proto-sampler\build\bin\mingwX64\releaseExecutable\main.exe'
    JsDir   = 'js-otel-proto-sampler'
    NeedsCollector = $true
  }
  'otel-proto-timesource' = @{
    Display = 'otel-proto-timesource (Protobuf/gRPC + monotonic clock)'
    Jar     = 'kmp-examples\fibonacci\fibonacci-otel-proto-timesource\build\lib\fibonacci-otel-proto-timesource-jvm-1.0.0.jar'
    Js      = 'kmp-examples\fibonacci\fibonacci-otel-proto-timesource\build\js\packages\fibonacci-otel-proto-timesource\kotlin\fibonacci-otel-proto-timesource.js'
    Exe     = 'kmp-examples\fibonacci\fibonacci-otel-proto-timesource\build\bin\mingwX64\releaseExecutable\main.exe'
    JsDir   = 'js-otel-proto-timesource'
    NeedsCollector = $true
  }
  'otel-proto-anchored' = @{
    Display = 'otel-proto-anchored (Protobuf/gRPC + SDK AnchoredClock)'
    Jar     = 'kmp-examples\fibonacci\fibonacci-otel-proto-anchored\build\lib\fibonacci-otel-proto-anchored-jvm-1.0.0.jar'
    Js      = 'kmp-examples\fibonacci\fibonacci-otel-proto-anchored\build\js\packages\fibonacci-otel-proto-anchored\kotlin\fibonacci-otel-proto-anchored.js'
    Exe     = 'kmp-examples\fibonacci\fibonacci-otel-proto-anchored\build\bin\mingwX64\releaseExecutable\main.exe'
    JsDir   = 'js-otel-proto-anchored'
    NeedsCollector = $true
  }
  'otel-proto-fastbatch' = @{
    Display = 'otel-proto-fastbatch (Protobuf/gRPC + O(1) BatchSpanProcessor drain)'
    Jar     = 'kmp-examples\fibonacci\fibonacci-otel-proto-fastbatch\build\lib\fibonacci-otel-proto-fastbatch-jvm-1.0.0.jar'
    Js      = 'kmp-examples\fibonacci\fibonacci-otel-proto-fastbatch\build\js\packages\fibonacci-otel-proto-fastbatch\kotlin\fibonacci-otel-proto-fastbatch.js'
    Exe     = 'kmp-examples\fibonacci\fibonacci-otel-proto-fastbatch\build\bin\mingwX64\releaseExecutable\main.exe'
