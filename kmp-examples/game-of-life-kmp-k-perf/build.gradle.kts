...
plugins {
<<<<<<< Updated upstream:kmp-examples/game-of-life-kmp-k-perf/build.gradle.kts
...
>>>>>>> Stashed changes:kmp-examples/game-of-life-kmp-dedicatedmain/build.gradle.kts
}
  ...
  jvm {
    ...
    */
    mainRun {
      ...
      mainClass.set("CommonApplicationKt")
    }
    compilations.all {
      tasks.withType<Jar> {
        doFirst {
          manifest {
            attributes(
              "Main-Class" to "CommonApplicationKt",
