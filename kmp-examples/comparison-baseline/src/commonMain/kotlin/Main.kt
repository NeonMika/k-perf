...
fun main(args: Array<String>) {
    // Kotlin/JS passProcessArgvToMainFunction() includes the script path in
    // args[0], so we scan all args for the first parseable Int instead of
    // relying on positional argv[0]. Works on JVM/Native/JS uniformly.
