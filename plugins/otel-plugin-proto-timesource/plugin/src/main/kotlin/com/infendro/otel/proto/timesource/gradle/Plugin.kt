package com.infendro.otel.proto.timesource.gradle
...
class Plugin : KotlinCompilerPluginSupportPlugin {
    ...
    override fun apply(
        ...
        target.extensions.add("otelProtoTimesource", Extension())
        super.apply(target)
    }
    ...
    override fun applyToCompilation(
        ...
        return project.provider {
            val extension = project.extensions.findByName("otelProtoTimesource") as Extension
            buildList {
    ...
    override fun getCompilerPluginId(): String = "otel-plugin-proto-timesource"
