...
import at.jku.ssw.kir.call.getCall
...
class KIRHelperKitTestingExtension(
  private val messageCollector: MessageCollector
) : IrGenerationExtension {

  val STRINGBUILDER_MODE = false

  val debugFile = File("./DEBUG_KIRHelperKitTesting.txt")
  ...
  override fun generate(moduleFragment: IrModuleFragment, pluginContext: IrPluginContext) {
    ...
    val stringBuilder: IrField = pluginContext.irFactory.buildField {
      name = Name.identifier("_kir_stringBuilder")
    ...
    val randomNumber = pluginContext.irFactory.buildField {
      name = Name.identifier("_kir_randNumber")
    ...
    val bufferedTraceFileName = pluginContext.irFactory.buildField {
      name = Name.identifier("_kir_bufferedTraceFileName")
    ...
    val bufferedTraceFileSink = pluginContext.irFactory.buildField {
      name = Name.identifier("_kir_bufferedTraceFileSink")
    ...
    val bufferedSymbolsFileName = pluginContext.irFactory.buildField {
      name = Name.identifier("_kir_bufferedSymbolsFileName")
      type = pluginContext.irBuiltIns.stringType
      isFinal = false
      isStatic = true
      visibility = DescriptorVisibilities.PRIVATE
    ...
    val bufferedSymbolsFileSink = pluginContext.irFactory.buildField {
      name = Name.identifier("_kir_bufferedSymbolsFileSink")
      type = rawSinkClass.defaultType
      isFinal = false
      isStatic = true
      visibility = DescriptorVisibilities.PRIVATE
    ...
    fun buildEnterFunction() {
      enterMethod = pluginContext.irFactory.buildFun {
        name = Name.identifier("_kir_enter_method")
    ...
    buildEnterFunction()
    firstFile.declarations.add(enterMethod!!)
    enterMethod!!.parent = firstFile
    ...
    fun buildGeneralExitFunction(): IrFunction {
      return pluginContext.irFactory.buildFun {
        name = Name.identifier("_kir_exit_method")
    ...
    main_tests(
      ...
      stringBuilderClass,
      stringBuilderConstructor,
      stringBuilderAppendIntFunc,
      stringBuilderAppendLongFunc,
      stringBuilderAppendStringFunc,
      printlnFunc,
      rawSinkClass,
      pathConstructionFunc,
      systemFileSystem,
      sizeProperty,
      firstFile,
      stringBuilder,
      ...
      flushFunc,
      toStringFunc,
      randomDefaultObjectClass,
      nextIntFunc,
      randomNumber,
      bufferedTraceFileName,
      bufferedTraceFileSink,
      bufferedSymbolsFileName,
      bufferedSymbolsFileSink,
      timeSourceMonotonicClass,
      funMarkNow,
      enterMethod!!,
      funElapsedNow,
      exitFunctionSymbol!!,
  ...
  private fun main_tests(
    pluginContext: IrPluginContext,
    timeMarkClass: IrClassSymbol,
    stringBuilderClass: IrClassSymbol,
    stringBuilderConstructor: IrConstructorSymbol,
    stringBuilderAppendIntFunc: IrSimpleFunctionSymbol,
    stringBuilderAppendLongFunc: IrSimpleFunctionSymbol,
    stringBuilderAppendStringFunc: IrSimpleFunctionSymbol,
    printlnFunc: IrSimpleFunctionSymbol,
    rawSinkClass: IrClassSymbol,
    pathConstructionFunc: IrSimpleFunctionSymbol,
    systemFileSystem: IrPropertySymbol,
    sizeProperty: IrPropertySymbol,
    firstFile: IrFile,
    stringBuilder: IrField,
    sinkFunc: IrSimpleFunctionSymbol,
    bufferedFunc: IrSimpleFunctionSymbol,
    writeStringFunc: IrSimpleFunctionSymbol,
    flushFunc: IrSimpleFunctionSymbol,
    toStringFunc: IrSimpleFunctionSymbol,
    randomDefaultObjectClass: IrClassSymbol,
    nextIntFunc: IrSimpleFunctionSymbol,
    randomNumber: IrField,
    bufferedTraceFileName: IrField,
    bufferedTraceFileSink: IrField,
    bufferedSymbolsFileName: IrField,
    bufferedSymbolsFileSink: IrField,
    timeSourceMonotonicClass: IrClassSymbol,
    funMarkNow: IrSimpleFunctionSymbol,
    enterMethod: IrSimpleFunction,
    funElapsedNow: IrSimpleFunctionSymbol,
    symbol: IrSimpleFunctionSymbol,
    startOffset: Int,
    endOffset: Int,
    valueParam0: IrValueParameter,
    valueParam1: IrValueParameter,
    oldBody: IrBlockBody
  ) {
    ...
    val findFunctionDefaultTestWithout =
      pluginContext.findFunctionOrNull("kotlin/collections/joinToString(*)", pluginContext.getIrType("bytearray"))
    val findFunctionDefaultTestWith1 = pluginContext.findFunctionOrNull(
      "kotlin/collections/joinToString(charsequence, *)",
      pluginContext.getIrType("bytearray")
    )
    ...
    val stringBuilderNew: IrField = pluginContext.irFactory.buildField {
      name = Name.identifier("_kir_stringBuilder2")
      type = stringBuilderClass.defaultType
      isFinal = false
      isStatic = true
      visibility = DescriptorVisibilities.PRIVATE
      ...
      this.initializer = DeclarationIrBuilder(
        pluginContext,
        firstFile.symbol
      ).callExpression(pluginContext) { stringBuilderConstructor() }
    }
    ...
    val stringBuilderNewCall: IrField = pluginContext.irFactory.buildField {
      name = Name.identifier("_kir_stringBuilder3")
      type = stringBuilderClass.defaultType
      isFinal = false
      isStatic = true
      visibility = DescriptorVisibilities.PRIVATE
    ...
    val stringBuilderNewCallDirect: IrField = pluginContext.irFactory.buildField {
      name = Name.identifier("_kir_stringBuilder4")
      type = stringBuilderClass.defaultType
      isFinal = false
      isStatic = true
      visibility = DescriptorVisibilities.PRIVATE
      ...
      this.initializer = DeclarationIrBuilder(
        pluginContext,
        firstFile.symbol
      ).callExpression(pluginContext) { call("kotlin/text/StringBuilder()") }
    }
    ...
    val stringBuilderSimpleField =
      pluginContext.createField(firstFile.symbol, "_stringBuilder5") { stringBuilderClass() }
    ...
    val randomNumber2 = pluginContext.irFactory.buildField {
      name = Name.identifier("_kir_randNumber2")
      type = pluginContext.irBuiltIns.intType
      isFinal = false
      isStatic = true
      visibility = DescriptorVisibilities.PRIVATE
    ...
    val randomNumber3 = pluginContext.irFactory.buildField {
      name = Name.identifier("_kir_randNumber3")
      type = pluginContext.irBuiltIns.intType
      isFinal = false
      isStatic = true
      visibility = DescriptorVisibilities.PRIVATE
    ...
    val randomNumber4 =
      pluginContext.createField(firstFile.symbol, "_randomNumber4") { randomDefaultObjectClass.call(nextIntFunc) }
    ...
    val irFileHandle = IrFileWriter(
      pluginContext,
      firstFile,
      "./trace_${pluginContext.platform!!.presentableDescription}_${(0..10000).random()}.txt"
    )

    val bufferedTraceFileSink2 = pluginContext.irFactory.buildField {
      name = Name.identifier("_kir_bufferedTraceFileSink2")
      type = rawSinkClass.defaultType
      isFinal = false
      isStatic = true
      visibility = DescriptorVisibilities.PRIVATE
    ...
    val bufferedTraceFileSink3 = pluginContext.irFactory.buildField {
      name = Name.identifier("_kir_bufferedTraceFileSink3")
      type = rawSinkClass.defaultType
      isFinal = false
      isStatic = true
      visibility = DescriptorVisibilities.PRIVATE
    ...
    val bufferedSymbolsFileSink2 = pluginContext.irFactory.buildField {
      name = Name.identifier("_kir_bufferedSymbolsFileSink2")
      type = rawSinkClass.defaultType
      isFinal = false
      isStatic = true
      visibility = DescriptorVisibilities.PRIVATE
    ...
    val enterMethodNew = pluginContext.irFactory.buildFun {
      name = Name.identifier("_kir_enter_method_new")
      returnType = timeMarkClass.defaultType
    }.apply {
      addValueParameter {
        name = Name.identifier("methodId")
    ...
    compareFieldDumps(enterMethod.dump(), enterMethodNew.dump(), "enter method")
    ...
    compareFieldDumps(oldBody.dump(), newBody.dump(), "exit method")
  ...
  @OptIn(UnsafeDuringIrConstructionAPI::class)
  private fun compareFunctionSymbols(
    original: IrSimpleFunctionSymbol,
