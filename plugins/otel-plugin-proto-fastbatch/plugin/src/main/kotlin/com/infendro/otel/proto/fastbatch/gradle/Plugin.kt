package com.infendro.otel.proto.fastbatch.gradle
...
class Plugin : KotlinCompilerPluginSupportPlugin {
    ...
    override fun apply(
        ...
        target.extensions.add("otelProtoFastbatch", Extension())
        super.apply(target)
    }

    fun KotlinMultiplatformExtension.addDependencies() {
        sourceSets.getByName("commonMain").dependencies {
            implementation("io.opentelemetry.kotlin.api:all:1.0.570-fastbatch")
            implementation("io.opentelemetry.kotlin.sdk:sdk-trace:1.0.570-fastbatch")
    ...
    override fun applyToCompilation(
        ...
        return project.provider {
            val extension = project.extensions.findByName("otelProtoFastbatch") as Extension
            buildList {
    ...
    override fun getCompilerPluginId(): String = "otel-plugin-proto-fastbatch"

    override fun getPluginArtifact(): SubpluginArtifact = SubpluginArtifact(
        groupId = "com.infendro.otel",
        artifactId = "plugin-proto-fastbatch",
        version = "1.0.1"
    )
}
