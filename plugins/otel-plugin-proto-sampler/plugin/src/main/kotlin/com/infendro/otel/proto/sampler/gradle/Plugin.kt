package com.infendro.otel.proto.sampler.gradle
...
class Plugin : KotlinCompilerPluginSupportPlugin {
    ...
    override fun apply(
        ...
        target.extensions.add("otelProtoSampler", Extension())
        super.apply(target)
    }
    ...
    override fun applyToCompilation(
        ...
        return project.provider {
            val extension = project.extensions.findByName("otelProtoSampler") as Extension
            buildList {
    ...
    override fun getCompilerPluginId(): String = "otel-plugin-proto-sampler"

    override fun getPluginArtifact(): SubpluginArtifact = SubpluginArtifact(
        groupId = "com.infendro.otel",
        artifactId = "plugin-proto-sampler",
        version = "1.0.1"
    )
}
