package com.infendro.otel.proto.combined.gradle
...
class Plugin : KotlinCompilerPluginSupportPlugin {
    ...
    override fun apply(
        ...
        target.extensions.add("otelProtoCombined", Extension())
        super.apply(target)
    }
    ...
    override fun applyToCompilation(
        ...
        return project.provider {
            val extension = project.extensions.findByName("otelProtoCombined") as Extension
            buildList {
    ...
    override fun getCompilerPluginId(): String = "otel-plugin-proto-combined"

    override fun getPluginArtifact(): SubpluginArtifact = SubpluginArtifact(
        groupId = "com.infendro.otel",
        artifactId = "plugin-proto-combined",
        version = "1.0.1"
    )
}
