package com.infendro.otel.plugin.proto.combined

import com.infendro.otel.plugin.proto.combined.ConfigurationKeys.KEY_DEBUG
import com.infendro.otel.plugin.proto.combined.ConfigurationKeys.KEY_ENABLED
import com.infendro.otel.plugin.proto.combined.ConfigurationKeys.KEY_HOST
import com.infendro.otel.plugin.proto.combined.ConfigurationKeys.KEY_MAX_EXPORT_BATCH_SIZE
import com.infendro.otel.plugin.proto.combined.ConfigurationKeys.KEY_MAX_QUEUE_SIZE
import com.infendro.otel.plugin.proto.combined.ConfigurationKeys.KEY_SERVICE
import com.infendro.otel.plugin.proto.combined.ConfigurationKeys.KEY_USE_SIMPLE_SPAN_PROCESSOR
import com.infendro.otel.plugin.proto.combined.ConfigurationKeys.KEY_INSTRUMENT_PROPERTY_ACCESSORS
...
class Processor : CommandLineProcessor {
    override val pluginId: String = "otel-plugin-proto-combined"
