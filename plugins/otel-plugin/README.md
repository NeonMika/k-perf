...
Of these, the utility library and exporter need to be published locally. Their source projects live at `plugin_dependencies/otel-utilities` and `plugin_dependencies/otlp-exporter`.
