package com.infendro.otel.proto.anchored.gradle
...
class Plugin : KotlinCompilerPluginSupportPlugin {
    ...
    override fun apply(
        ...
        target.extensions.add("otelProtoAnchored", Extension())
        super.apply(target)
    }
    ...
    override fun applyToCompilation(
        ...
        return project.provider {
            val extension = project.extensions.findByName("otelProtoAnchored") as Extension
            buildList {
    ...
    override fun getCompilerPluginId(): String = "otel-plugin-proto-anchored"

    override fun getPluginArtifact(): SubpluginArtifact = SubpluginArtifact(
        groupId = "com.infendro.otel",
        artifactId = "plugin-proto-anchored",
        version = "1.0.0"
    )
}
